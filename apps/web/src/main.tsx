  ...
  return <div className="app-shell">
    ...
    <main>
      <header className="topbar">
        ...
        <div className="top-actions"><button className="search">⌕ <span>搜索</span></button><button className="new-card">＋ {isRecordView ? "新建记录" : "新建手册"}</button></div>
      </header>
      <section className="page-heading">
        <div><p className="eyebrow">{child}的观察档案 · 2026</p><h1>{heading}</h1><p className="subhead">{isRecordView ? "把当下的发现，收进时间的册页。" : activeNav === "观察手册" ? "将同一主题的发现编成可以持续生长的手册。" : "按孩子独立整理和查看内容。"}</p></div>
