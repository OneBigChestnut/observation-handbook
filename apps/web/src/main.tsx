  ...
  return <div className="app-shell">
    ...
    <main>
      <header className="topbar">
        ...
        <div className="top-actions"><button className="search">⌕ <span>搜索</span></button>{canEditFamily && !isPublicSpace && !isFamilyMembers && !isAdminCenter && <button className="new-card" onClick={() => isRecordView ? setApiComposerOpen(true) : activeNav === "观察手册" ? setHandbookDialogOpen(true) : activeNav === "标签管理" ? setTagDialogOpen(true) : activeNav === "导出文件" ? setExportDialogOpen(true) : undefined}>＋ {actionLabel}</button>}</div>
      </header>
      ...
      {activeNav === "标签管理" && <section className="tag-view"><div className="tag-rule"><p>全部标签</p><i></i><span>当前小朋友的观察主题</span></div><ChildTagList childId={currentChildId} /></section>}
