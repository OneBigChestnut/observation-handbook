  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {isRecordView && <section className="month-view">
        ...
        <ChildContentLoader key={`${currentChildId}-${contentReloadKey}`} childId={currentChildId} view={view} />
      </section>}
      {activeNav === "观察手册" && <section className="handbook-view"><div className="handbook-rule"><p>正在整理</p><i></i><span>按最近更新</span></div><ChildHandbookList key={`${currentChildId}-${contentReloadKey}`} childId={currentChildId} /></section>}
